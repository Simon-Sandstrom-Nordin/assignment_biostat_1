...
The following plots shows the population size between genders across different age groups.
...
toplot %>% 
  ...
  xlab("Year") + ylab("Number of cases per 10^4 population (log scale)") 
```
The fit cannot always capture the curvature in the data, for example in the case of females and ages 85-89.
...
The curve for the standardised fitted rates appears to follow the standardized original rates quite well for men. For female, however, this is no as clear, which might just be a consequence of the less linear curve for females than for males, as the female standardized original rates fluctuate more.
