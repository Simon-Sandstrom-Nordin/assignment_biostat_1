...
Dataset cases contains the yearly number of reported cancer cases (variable "n") by age group (variable "agegroup") and sex (variable "sex"), with variable "year" ranging from 1970 to 2022. Eighteen different age groups are defined, as:
...
The curve for the standardised fitted rates appears to follow the standardized original rates quite well for men. For females, however, this is not as clear, which might just be a consequence of the less linear curve for females' original rates with respect to the males'.
