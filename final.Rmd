...
Definition of incidence rate: "for a specific follow-up period, the number of new cases of the outcome divided by the total person-time at risk" (Adina Feldman, Lecture 2). In our case, for each period of one year, the incidence rate is defined as the number of new reported cases of cancer in that year, divided by the total person-time (1 year times population in that year). \

In this document, incidence rates are rescaled by a factor of $10^4$, and for each year they correspond to the number of reported cases per 10000 population.
